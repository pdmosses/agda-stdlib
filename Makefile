...
https://pdmosses.github.io/agda-stdlib/
...
# CHECK THE AGDA CODE:
# make check                          16 seconds

# GENERATE AND BROWSE A WEBSITE:
# make web                            79 seconds
# make serve                          68 seconds

# REMOVE ALL GENERATED FILES:
# make clean-all                       1 second

# DEPLOY A GENERATED WEBSITE:        103 seconds
# make deploy
...
# make -f Makefile debug  0.01s user 0.01s system 81% cpu 0.016 total