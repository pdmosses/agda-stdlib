...
!!! note
    ...
    The [**README** section](md/README/index.md) contains all the modules imported
    by [doc/README.agda](https://github.com/pdmosses/agda-stdlib/blob/master/doc/README.agda).

    The [**Library** section](Library/index.md) contains the built-in and standard
    library modules that are (transitively) imported by the `README` modules.

    The [**HTML** section](html/README.html) contains the highlighted HTML pages
